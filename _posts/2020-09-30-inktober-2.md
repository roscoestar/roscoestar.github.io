...
featured_image: /assets/images/posts/ink-2020-23.jpg
featured: true
hidden: true
---
...
Note that since the month isn't over, there're only a few drawings up so far.  I will update this post every day with a new one, so please check back to see more of my work later!
...
Deep-water animals are always so scary.  I gave mine some bioluminescent spots so he can see a bit; I'm not sure how realistic that would be for a diapsid reptile.
