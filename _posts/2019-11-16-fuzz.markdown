...
Above: Jeholopterus (meaning “Jehol wing”), an anurognathid pterosaur from Middle to Late Jurassic China, found with directly preserved pycnofibres.  Anurognathids (meaning “frog jaw”) were a group of small, nocturnal, short-tailed, short-faced pterosaurs that probably filled the same niche that bats do today.
...
Stage 1 is a simple filament, which is probably ancestral to all archosaurs.  That means basically any archosaur under the Yutyrannus threshold is fair game for sporting these.  Stage 2 is a fiber bundle, such as the down feathers found in a pillow.  Stage 3 is a simple branched feather.  The small ornithischian Kulindadromeus was known to have this type of feather, which means that phylogenetically, any dinosaur can have these, but be wary of putting them on non-dinosaurian archosaurs.  Stage 4 has the feather barbs branching further and sporting barbules, which allow the feather to zipper itself together into a single surface, and Stage 5 is a fully-developed flight feather with an asymmetric leading edge and a smooth texture.  Only theropods are known to have Stage 4 and 5 feathers, and probably only maniraptorans or even paravians would have had Stage 5.  From fossilized skin impressions (outlined in Mark Witton's chart above), we know that true sauropods and the ceratosaur Carnotaurus had secondarily lost their fuzz, so for creatures nearby these on the family tree, feather with extreme caution.
