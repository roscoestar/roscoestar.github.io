...
{% include image-caption.html imageurl="/assets/images/posts/i-am-a-fish-1.1.png" title="fig1" caption="Figure 1. A Cloob (left) and a Greeb (right)." %}
...
{% include image-caption.html imageurl="/assets/images/posts/i-am-a-fish-1.2.png" title="fig2" caption="Figure 2. Two Cloob parents and their mutant green-Cloob child." %}
...
{% include image-caption.html imageurl="/assets/images/posts/i-am-a-fish-1.3.png" title="fig3" caption="Figure 3. A Greeb (left), a Grap (right), and a transitionary form (Greep?) (center)." %}
...
{% include image-caption.html imageurl="/assets/images/posts/i-am-a-fish-1.4.png" title="fig4" caption="Figure 4. A phylogenetic tree showing the lineage of Cloobs, Graps, and Greebs.  The magenta circle indicates the proposed 'Warmcolorite' clade." %}
...
{% include image-caption.html imageurl="/assets/images/posts/i-am-a-fish-1.5.png" title="fig5" caption="Figure 5. A phylogenetic tree showing the lineage of goldfish, coelacanths, and humans.  The magenta circle indicates the polyphyletic group commonly known as 'fish'." %}
...
{% include image-caption.html imageurl="/assets/images/posts/you-are-a-fish.png" title="you are" caption="Believe it or not, I did not make this meme." %}
