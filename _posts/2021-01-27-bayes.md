...
Now, how do we solve for the constants k and n<sub>0</sub>?  We can plug in two known points, in this case P<sub>gay</sub>(0) and P<sub>gay</sub>(1).  The former is equal to 3%, and for the latter we'll apply the "increases by 33%" just once to get 4%.
...
This was how I derived the equation I used years ago 
