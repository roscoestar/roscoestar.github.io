...
A **ghost lineage** is a line of descent we know must exist because we have fossil or living evidence for its descendents, but we haven't found any fossil evidence for the ancestors.  The most famous example is the coelacanth, a type of rare lobe-finned fish that is present in the fossil record up to the Cretaceous Period, but then appears to go extinct.  However, living coelacanths still exist; we just haven't found any fossils of them younger than Cretaceous age, making that line of descent a ghost lineage.  Read a more detailed explanation [here](https://ucmp.berkeley.edu/taxa/verts/archosaurs/ghost_lineages.php).
